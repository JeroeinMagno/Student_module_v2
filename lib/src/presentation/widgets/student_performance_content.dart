...
class _StudentPerformanceContentState extends State<StudentPerformanceContent> {
          ...
          child: Column(
            ...
            children: [
              Text(
                'Enrolled Units',
                style: TextStyle(
                  color: isDarkMode ? const Color(0xFF4ADE80) : Theme.of(context).colorScheme.primary,
                  fontSize: 16.sp,
  ...
  Widget _buildAssessmentTracker(BuildContext context) {
    final isDarkMode = Theme.of(context).brightness == Brightness.dark;
    final progressBackgroundColor = isDarkMode ? Colors.white10 : Colors.black.withValues(alpha: 0.1);
                      ...
                      SizedBox(
                        ...
                        child: CircularProgressIndicator(
                          ...
                          valueColor: AlwaysStoppedAnimation<Color>(
                            isDarkMode ? const Color(0xFF4ADE80) : Theme.of(context).colorScheme.primary
                          ),
                        ),
                      ),
                      Column(
  ...
  DataRow _buildAssessmentRow(String courseCode, String assessment, String status, String score) {
    Color statusBgColor;
  ...
  Widget _buildGWATrendCard(BuildContext context) {
    ...
    // Convert grade trends data to chart spots
    ...
    // Debug: Print data to verify it's loaded
                    ...
                    lineBarsData: [
                      LineChartBarData(
                        spots: spots.isNotEmpty ? spots : [
                          ...
                          const FlSpot(4, 2.75), // Inverted: Original 1.25 -> 4.0-1.25 = 2.75
                        ],
                        isCurved: true,
